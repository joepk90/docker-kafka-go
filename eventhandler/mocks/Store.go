...
// AddEventRecord provides a mock function with given fields: ctx, arg
func (_m *Store) AddEventRecord(ctx context.Context, arg gen.AddEventRecordParams) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, gen.AddEventRecordParams) error); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Error(0)
	}
